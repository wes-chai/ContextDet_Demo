...
class ContextDetDemo():
    ...
    def forward(self, image, text, task_button, history, threshold=0.3):
        ...
        print(visualize_prediction(image, results, threshold))
        # return [outputs['output_text'][0], visualize_prediction(image, results, threshold)]
